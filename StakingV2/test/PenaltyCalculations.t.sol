...
contract PenaltyCalculations is Test, Setup {
    ...
    function testPenaltyCalculationWithinLockPeriod() public {
        ...
        vm.prank(user1);
        lock.earlyExitById(lockedBalance.lockId, 100e18 - 185e17);
        ...
        lock.earlyExitById(lockedBalance.lockId, 50e18 - 25e18);
        ...
        lock.earlyExitById(lockedBalance.lockId, 50e18 - 11e18);
        user1BalanceAfter = _stakingToken.balanceOf(user1);
        ...
        lock.earlyExitById(lockedBalance.lockId, 100e18 - 36e18);
        user1BalanceAfter = _stakingToken.balanceOf(user1);
        assertEq(user1BalanceBefore + (100e18 - 36e18), user1BalanceAfter);
    }

    function testEarlyExitByIdRevertWithLowerExpectedValue() public {
        vm.prank(user1);
        lock.stake(100e18, 0);
        vm.prank(deployer);
        lock.setDefaultRelockTime(5);
        ...
        LockedBalance memory lockedBalance = lock.locklist().getLock(user1, 0);
        vm.prank(user1);
        // expected value: 100e18 - 185e17
        vm.expectRevert();
        lock.earlyExitById(lockedBalance.lockId, 100e18 - 186e17);
    }

    function testEarlyExitByIdPassWithHigherExpectedValue() public {
        vm.prank(user1);
        lock.stake(100e18, 0);
        vm.prank(deployer);
        lock.setDefaultRelockTime(5);
        ...
        vm.prank(user1);
        // expected value: 100e18 - 185e17
        lock.earlyExitById(lockedBalance.lockId, 100e18 - 184e17);
        uint256 user1BalanceAfter = _stakingToken.balanceOf(user1);
        assertEq(user1BalanceBefore + (100e18 - 185e17), user1BalanceAfter);
    }
}
