...
contract RestakeAfterLateExit is Test {
    ...
    function testUserBRestakeAfterLateExit() public {
        ...
        vm.startPrank(user2);
        lock.stake(100e18, 1); // User 2 stakes with the second lock type which is 60 days
    ...
    function testUserCRestakeAfterLateExit() public {
        ...
        vm.startPrank(user3);
        lock.stake(100e18, 2); // User 2 stakes with the 3rd lock type which is 360 days
    ...
    function testUserCRestakeAfterLateExitForTimeLessThanDefaultRelockPeriod() public {
        ...
        vm.startPrank(user3);
        lock.stake(100e18, 2); // User 3 stakes with the 3rd lock type which is 360 days
    ...
    /// @notice check exitLateById reverted at 2nd call
    function testExitLateByIdIsRevertedInSeconodCall() public {
        vm.prank(deployer);
        lock.setDefaultRelockTime(45 days);
        vm.startPrank(user3);
        lock.stake(100e18, 2); // User 3 stakes with the 3rd lock type which is 360 days
